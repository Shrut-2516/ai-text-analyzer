...
✂️ Summarization — Condenses long text into a brief and clear summary.

⚡ AI Automation — Powered by n8n workflows and Gemini API.

💻 Modern UI — Responsive, minimalist interface designed with Tailwind CSS.
...
Click Sentiment Analysis or Summarization.
